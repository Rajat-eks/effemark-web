    ...
    <main className="flex flex-col md:flex-row p-4 sm:p-6 md:p-14 gap-5">
      <section className="w-full md:w-[65%] space-y-5">
        ...
        <div className="space-y-4 sm:space-y-5 text-justify">
          ...
          <h3 className="text-[16px] sm:text-[18px] md:text-[20px] font-bold">Domain Name Monitoring</h3>
          <p className="text-[14px] sm:text-[15px] md:text-[16px]">
          ...
          <h3 className="text-[16px] sm:text-[18px] md:text-[20px] font-bold">Social Media Tracking</h3>
          <p className="text-[14px] sm:text-[15px] md:text-[16px]">
          ...
          <p className="text-[14px] sm:text-[15px] md:text-[16px]">Once violations are detected, swift enforcement is essential:</p>
          <ul className="list-disc list-inside space-y-2 text-[14px] sm:text-[15px] md:text-[16px]">
            <li>
          ...
          <h2 className="text-[20px] sm:text-[22px] md:text-[25px] font-bold">Measuring Success</h2>
          <p className="text-[14px] sm:text-[15px] md:text-[16px]">
