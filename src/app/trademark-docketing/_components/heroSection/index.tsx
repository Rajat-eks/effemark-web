...
const HeroSection: React.FC<IndexProps> = ({
  ...
  return (
    <div className="hero-section relative h-[70vh] md:h-[400px] w-full">
      {/* Background Image */}
      <Image
        src={banner}
        alt="Background"
      ...
      <div className="absolute inset-0 flex flex-col justify-between  bg-black/70 p-4 md:p-10 text-white">
        <h1 className="sm:text-3xl text-3xl md:text-[55px] font-bold z-10 md:w-[900px] leading-10 sm:leading-18">
          {title}
        </h1>
        <p className="text-[18px] sm:text-xl md:w-[1100px] text-justify">
          {description}
        </p>
